...
class EvaluateTutor extends StatefulWidget {
  @override
  _EvaluateTutorState createState() => _EvaluateTutorState();
}

class _EvaluateTutorState extends State<EvaluateTutor> {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: StreamBuilder<List<Session>>(
        stream: TutorDataService(id: profile.uid).sessiontutorevaluate,
